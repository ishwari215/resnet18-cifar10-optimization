...
## I apologize for the confusion. Here is the final, complete README.md content in a single Markdown block, ready for you to copy and paste into your GitHub repository.

Markdown

# resnet18-cifar10-optimization

Hybrid optimization of a **ResNet-18** classifier for **CIFAR-10** using **Gradient Descent**, **PSO**, **CMA-ES**, and **NSGA-II** on the final layer weights.
...
## 👤 Author
Shivasmi Sharma | Data Scientist | MSc Data Science | https://www.linkedin.com/in/ishwari-niphade/ | https://github.com/ishwari215
